return {
	...
	config = function()
		local system_prompt =
			"NO EXTRA TEXTS TO BE GIVEN BACK. NO BACKTICKS OR LANGUAGE MENTIONED IN ANY CIRCUMSTANCE. PURE CODE IN THE LANGUAGE ASKED FOR. REPLACE THE COMMENT THAT GIVES YOU ORDERS AND ENSURE NO BACKTICKS IN ANY CASE. You should replace the code that you are sent. Do not talk at all. Only output valid code. ENSURE NO BACKTICKS ``` IN THE CODE"
